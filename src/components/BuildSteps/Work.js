import { Accordion, AccordionButton, AccordionIcon, AccordionItem, AccordionPanel, Box, Button, FormControl, FormLabel, HStack, Input, Select, Text, Textarea, VStack } from '@chakra-ui/react';
                ...
                {workList.map((work, index) => (
                    <AccordionItem key={index}>
                        ...
                        <AccordionPanel pb={4}>
                            ...
                            {/* Responsive layout: VStack for mobile, HStack for larger screens */}
                            <HStack spacing={3} mt={4} flexDirection={['column', 'row']}>
                                <FormControl>
